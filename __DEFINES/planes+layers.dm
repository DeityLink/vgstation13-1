...
#define ABOVE_HUMAN_PLANE 		(10 + FLOAT_PLANE)			// For things that should appear above humans.
	...
	#define CANVAS_LAYER				0.2					// So that canvas always appear above easels
	#define EASEL_OVERLAY_LAYER			0.3					// So that the easel bits that hold a canvas in place always appear above a canvas
